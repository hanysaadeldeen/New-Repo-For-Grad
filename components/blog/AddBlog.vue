<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gray-900 p-4 text-white"
  >
    <Form
      @submit="onSubmit"
      class="w-full max-w-lg rounded-lg bg-gray-800 p-6 shadow-lg"
    >
      ...
      <!-- Introduction -->
      <div class="mb-4">
        <label for="introduction" class="mb-2 block text-sm font-medium"
          >Introduction</label
        >
      ...
      <!-- What is Fog -->
      <div class="mb-4">
        <label for="whatIsFog" class="mb-2 block text-sm font-medium"
          >What is Fog</label
        >
      ...
      <!-- Data Leak Site (DLS) -->
      <div class="mb-4">
        <label for="dataLeakSite" class="mb-2 block text-sm font-medium"
          >Data Leak Site (DLS)</label
        >
...
<style scoped>
/* Additional styles for dark mode enhancements */
textarea:focus {
